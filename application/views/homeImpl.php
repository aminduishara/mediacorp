...
<div class="container pt-5 pb-1 mb-5">
  <div class="col-12 text-end">
    ...
    <div class="col-md-4 offset-md-8">
      <div class="row">
        <label for="" class="col-md-6">Ref. No:</label>
        <div class="col-md-6">
  ...
  <div class="col-12">
    <div class="card">
      <div class="row" style="position: relative;">
        <div class="svg d-none d-md-block d-lg-block d-xl-block d-xxl-block" style="position: absolute; top: -8px; left: -100px; height: 130px; width: 130px;">
          ...
          <svg width="100" height="130" viewBox="0 0 50 57" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M49.3098 48.5714C49.6048 55.1429 44 56 44 56V42C44 42 49.0148 42 49.3098 48.5714Z" fill="white" stroke="white" stroke-width="0.5" />
        ...
        <div class="col-md-11">
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="general-tab">
              <?php include 'application/views/Forms/generalInfo.php'; ?>
            </div>
            <div class="tab-pane fade" id="description-tab-pane" role="tabpanel" aria-labelledby="description-tab">
              <?php include 'application/views/Forms/description.php'; ?>
            </div>
            <div class="tab-pane fade" id="img-tab-pane" role="tabpanel" aria-labelledby="img-tab">
              <?php include 'application/views/Forms/img.php'; ?>
            </div>
          </div>
        </div>
      </div>
