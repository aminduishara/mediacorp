    <form class="rounded p-4">
        ...
        <div class="row mt-4 mb-4">
            <div class="form-group col-md-12 text-end">
                ...
                <input type="button" class="text-white btn btn-md btn-warning px-5 mt-5 float-start" value="Edit Application" id="butViewEdit" data-bs-toggle="tooltip" title="Edit your existing Application" data-bs-placement="top">
